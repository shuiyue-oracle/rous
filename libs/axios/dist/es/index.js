...
var defaultResponseErrorInterceptor = function defaultResponseErrorInterceptor(error) {
  console.log(error);
  var message = "";
  switch (error.status) {
    case 400:
    ...
    case 505:
      ...
      break;
    default:
      message = "\u7CFB\u7EDF\u9519\u8BEF\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5(".concat(error.code, ")!");
  }
...
var AxiosRequest = function () {
  function AxiosRequest(config) {
    var _this = this;
    this.responseInterceptorRejected = defaultResponseErrorInterceptor;
    this.requestInterceptor = function (reqResolve, reqRejected) {
      _this.instance.interceptors.request.use(reqResolve, reqRejected);
    };
    this.responseInterceptor = function (resResolve, resRejected) {
      _this.instance.interceptors.response.use(resResolve, resRejected);
    };
    this.request = function (config) {
      return _this.instance.request(config);
    };
    ...
    this.put = function (url, config) {
      return _this.instance.post(url, config);
    };
    ...
    this.putForm = function (url, data, config) {
      return _this.instance.post(url, data, config);
    };
    this.patchForm = function (url, data, config) {
      return _this.instance.post(url, data, config);
    };
    this.instance = axios$2.create(config);
...
var myAxios = AxiosRequest;
var axios = new AxiosRequest();
var request = axios.request;
var get = axios.get;
var head = axios.head;
var options = axios.options;
var post = axios.post;
var put = axios.put;
var patch = axios.patch;
var postForm = axios.postForm;
var putForm = axios.putForm;
var patchForm = axios.patchForm;

export { axios as default, get, head, myAxios, options, patch, patchForm, post, postForm, put, putForm, request };
